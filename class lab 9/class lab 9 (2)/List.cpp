...
{
	if (s > MAX_SIZE) throw Error("Size > MAX_SIZE");
...
List::List(List& a)
{
	if (a.get_size() > MAX_SIZE) throw Error("Copy list size > MAX_SIZE");
...
{
	if (this->size > MAX_SIZE - 1) throw Error("Size can't be more than MAX_SIZE");
...
void List::pop_back()
{
	if (this->size == 0) throw Error("Size = 0");
...
{
	if (a.size > MAX_SIZE) throw Error("Copy list size > MAX_SIZE");
...
List& List::operator+(List& a)
{
	if (this->size + a.size > MAX_SIZE) throw Error("Size > MAX_SIZE");
...
{
	if (this->size > MAX_SIZE - 1) throw Error("Size cant't be more than MAX_SIZE");
	this->push_front(a);
}
